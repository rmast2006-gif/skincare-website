          ...
          <div className="flex flex-col justify-center">
            ...
            {product.skinType && (
              <p className="text-sm text-gray-500 mb-2">
                ...
                {product.skinType.toUpperCase()}
              </p>
            )}

            {product.texture && (
              <p className="text-sm text-gray-500 mb-4">
                <span className="font-semibold text-gray-700">Texture:</span> {product.texture}
              </p>
            )}

            <div className="flex items-baseline gap-2 mb-6">
              <span className="text-4xl font-bold" style={{ color: '#c9a96e' }}>
                {product.price}
              </span>
            ...
            <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
              ...
              <DialogContent className="sm:max-w-md">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                  ...
                  <button type="submit" className="w-full py-3 rounded-xl text-white font-semibold bg-green-600 hover:bg-green-700 transition-all">
                ...
                if (match) {
                  ...
                  return (
                    <div className="space-y-4">
                      {spotlight && (
                        <div>
                          <p className="text-xs font-semibold text-gray-400 uppercase tracking-wide mb-2">Spotlight Ingredients</p>
                      ...
                      {key && (
                        <div>
                          <p className="text-xs font-semibold text-gray-400 uppercase tracking-wide mb-2">Key Ingredients</p>
                          <ul className="space-y-1">
